...
import '../lib/leaflet-tilelayer-colorizr.js';
...
.leafletMapTest {
  ...
  /deep/.leaflet-zoom-animated img {
    ...
    -ms-filter: invert(1) grayscale(0) saturate(0.5) brightness(1.6) opacity(1)
      hue-rotate(334deg) sepia(10%) !important;
    -moz-filter: invert(1) grayscale(0) saturate(0.5) brightness(1.6) opacity(1)
      hue-rotate(334deg) sepia(10%) !important;
